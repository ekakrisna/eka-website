...
$blog_section_title = $hotel_vivanta_options['blog_title'];
$blog_desc = $hotel_vivanta_options['blog_desc'];
$blog_category = $hotel_vivanta_options['blog_category'];
$content_length = '100';
if($blog_show) {
                            ...
                            <div class="col-md-4 col-sm-4">
                                <div class="blog-wrap">
                                  ...
                                  <figcaption>
                                    ...
                                    <p><?php echo wp_kses_post(hotel_vivanta_get_excerpt($recent_query->post->ID, $content_length)); ?></p>
                                  </figcaption>
                                </div>
                            </div>
                        <?php endwhile;
