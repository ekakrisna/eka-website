...
class Biteship_Shipping_Method extends WC_Shipping_Method {
    public function __construct() {
        ...
        $this->option_list = array( 'store_name', 'shipper_name', 'shipper_phone_no',  'shipper_email',
                                    ...
                                    'checkout_type',
                                    'insurance_enabled', 'cod_enabled',
                                    'tracking_page_url', 'tracking_page_isactive', // new tracking page
                                    'multiple_origins_isactive', 'default_address', 'multiple_addresses',
    ...
    private function save_settings() {
        ...
        if (wp_verify_nonce( @$_REQUEST['biteship-nonce'], 'biteship-settings' )) {
            ...
            //Ilyasa - Toggle Update Status Order Otomatiss
                    ...
                    if(strlen($new_multiorigin_shop_name) > 0 && strlen($new_multiorigin_address) > 0){
                        ...
                        if($save_multiple_origin){
                            ...
                            if(!is_array($_POST['multiple_addresses'])){
                                $_POST['multiple_addresses'] = array();
                            }
