...
class Biteship_Public {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/biteship-public.js', array( 'jquery' ), $this->version."-".md5(date("Y-m-d H:i:s")), false );
		wp_enqueue_script( "biteship_jquery_ui", plugin_dir_url( __FILE__ ) . 'js/jquery-ui.min.js', array( 'jquery' ), $this->version, false );
		...
		if(strlen(WC()->customer->get_billing()["email"]) > 0){
