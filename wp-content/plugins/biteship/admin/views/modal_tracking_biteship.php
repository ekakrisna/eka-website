	...
	<div class="wc-backbone-modal">
		<div class="wc-backbone-modal-content">
			<section class="wc-backbone-modal-main" role="main">
				...
				<footer>
					<div class="inner">
                        <button onclick="redirectPageTracking('{{{ data.waybill_id }}}', '{{{ data.waybill_url }}}')" class="button button-primary button-large"><?php esc_html_e( 'Cek Order', 'woocommerce' ); ?></button>
					</div>
				</footer>
			</section>
		</div>
