...
<table class="form-table">
  ...
  <tr>
    ...
    <td>
      <span>
        <input type="text" value="<?php echo $options['shipper_email'] ?>" name="shipper_email" placeholder="Contoh: john.doe@gmail.com"  oninvalid="this.setCustomValidity('Email Pengirim belum diisi. Disarankan menggunakan email yang sama seperti di akun Biteship')" required/>
  ...
  <tr>
    ...
    <td style="vertical-align: top">
      <!-- <legend style="margin-top: 15px;"><font color=red><?php echo __('Pastikan untuk pilihan dropdown, disarankan tidak mengcustom halaman checkout mengunakan plugin lain.', 'biteship') ?></font></legend> -->
    </td>    
  </tr>
  <tr>
      <?php
      ...
      <div style="margin-top: -10px">
        ...
        <div id="component-tracking-page" style="display: <?= $tracking_page_isactive_style ?>;">
          ...
          <span style="margin-left: 1px;">
            <input type="text" value="<?php echo $options['tracking_page_url'] ?>" placeholder="https://dashboard.biteship.com/track-uniqlo" name="tracking_page_url" id="tracking_page_url"/>
      ...
      <div style="margin-top: -10px">
        ...
        <div id="component-multiorigins-page" style="margin-right:-40px; display: <?= $multiple_origins_isactive_style ?>;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center">
            ...
            <div style="display: flex; align-items: center">
              <div style="margin-left: 8px; padding-right: 8px">
                <label for="<?php echo $html_id ?>"><?=$address['shopname'] .(isset($list_province[$address['province']])? ' - '. $list_province[$address['province']]: "")?><br><?php echo $address['address'] . ' - ' . $address['zipcode'] ?></label>
                <br><br>
            ...
            <button class="wp-core-ui button-secondary" style="background-color: transparent; border-color: transparent; color: #c9356e" type="submit" name="default_address" value="<?php echo $id ?>">
              <label class="switch">
                  <input class="shipping-service-checkbox" type="checkbox" value="<?php echo $id ?>" <?php if($options['default_address'] == $id) echo 'checked' ?> />
                  <span class="slider round"></span>
              </label>
            </button>
            </div>
    ...
    <td>
      <span>
        ...
        <div id="component-validate-licence">
            ...
            <div style="margin-top: 16px">
                <button type="button" id="active-licence" class="wp-core-ui button-primary"><?=($options["informationLicence"]["message"] === "success" ? "Ubah Lisensi" : "Aktivasi")?></button>
            </div>
        </div>
